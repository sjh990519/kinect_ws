...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(DebayerConfig::AbstractParamDescriptionConstPtr(new DebayerConfig::ParamDescription<int>("debayer", "int", 0, "Debayering algorithm", "{'enum': [{'name': 'Bilinear', 'type': 'int', 'value': 0, 'srcline': 10, 'srcfile': '/home/pi/catkin_ws/src/image_pipeline/image_proc/cfg/Debayer.cfg', 'description': 'Fast algorithm using bilinear interpolation', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'EdgeAware', 'type': 'int', 'value': 1, 'srcline': 12, 'srcfile': '/home/pi/catkin_ws/src/image_pipeline/image_proc/cfg/Debayer.cfg', 'description': 'Edge-aware algorithm', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'EdgeAwareWeighted', 'type': 'int', 'value': 2, 'srcline': 14, 'srcfile': '/home/pi/catkin_ws/src/image_pipeline/image_proc/cfg/Debayer.cfg', 'description': 'Weighted edge-aware algorithm', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'VNG', 'type': 'int', 'value': 3, 'srcline': 16, 'srcfile': '/home/pi/catkin_ws/src/image_pipeline/image_proc/cfg/Debayer.cfg', 'description': 'Slow but high quality Variable Number of Gradients algorithm', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'Debayering algorithm'}", &DebayerConfig::debayer)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(DebayerConfig::AbstractParamDescriptionConstPtr(new DebayerConfig::ParamDescription<int>("debayer", "int", 0, "Debayering algorithm", "{'enum': [{'name': 'Bilinear', 'type': 'int', 'value': 0, 'srcline': 10, 'srcfile': '/home/pi/catkin_ws/src/image_pipeline/image_proc/cfg/Debayer.cfg', 'description': 'Fast algorithm using bilinear interpolation', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'EdgeAware', 'type': 'int', 'value': 1, 'srcline': 12, 'srcfile': '/home/pi/catkin_ws/src/image_pipeline/image_proc/cfg/Debayer.cfg', 'description': 'Edge-aware algorithm', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'EdgeAwareWeighted', 'type': 'int', 'value': 2, 'srcline': 14, 'srcfile': '/home/pi/catkin_ws/src/image_pipeline/image_proc/cfg/Debayer.cfg', 'description': 'Weighted edge-aware algorithm', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'VNG', 'type': 'int', 'value': 3, 'srcline': 16, 'srcfile': '/home/pi/catkin_ws/src/image_pipeline/image_proc/cfg/Debayer.cfg', 'description': 'Slow but high quality Variable Number of Gradients algorithm', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'Debayering algorithm'}", &DebayerConfig::debayer)));

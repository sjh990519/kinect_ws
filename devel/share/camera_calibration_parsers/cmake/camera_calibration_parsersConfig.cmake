...
if("TRUE" STREQUAL "TRUE")
  set(camera_calibration_parsers_SOURCE_PREFIX /home/pi/catkin_ws/src/image_common/camera_calibration_parsers)
  set(camera_calibration_parsers_DEVEL_PREFIX /home/pi/catkin_ws/devel)
  ...
  set(camera_calibration_parsers_INSTALL_PREFIX /home/pi/catkin_ws/install)
...
if(NOT "/home/pi/catkin_ws/src/image_common/camera_calibration_parsers/include " STREQUAL " ")
  set(camera_calibration_parsers_INCLUDE_DIRS "")
  set(_include_dirs "/home/pi/catkin_ws/src/image_common/camera_calibration_parsers/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'camera_calibration_parsers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/catkin_ws/src/image_common/camera_calibration_parsers/${idir}'.  ${_report}")
    endif()

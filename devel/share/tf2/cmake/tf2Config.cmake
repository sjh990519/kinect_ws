...
if("TRUE" STREQUAL "TRUE")
  set(tf2_SOURCE_PREFIX /home/pi/catkin_ws/src/geometry2/tf2)
  set(tf2_DEVEL_PREFIX /home/pi/catkin_ws/devel)
  set(tf2_INSTALL_PREFIX "")
  set(tf2_PREFIX ${tf2_DEVEL_PREFIX})
else()
  set(tf2_SOURCE_PREFIX "")
  set(tf2_DEVEL_PREFIX "")
  set(tf2_INSTALL_PREFIX /home/pi/catkin_ws/install)
...
if(NOT "/home/pi/catkin_ws/src/geometry2/tf2/include;/usr/include " STREQUAL " ")
  set(tf2_INCLUDE_DIRS "")
  set(_include_dirs "/home/pi/catkin_ws/src/geometry2/tf2/include;/usr/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'tf2' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/catkin_ws/src/geometry2/tf2/${idir}'.  ${_report}")
    endif()
    _list_append_unique(tf2_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "tf2;/usr/lib/arm-linux-gnueabihf/libconsole_bridge.so.0.4")

...
if("TRUE" STREQUAL "TRUE")
  set(image_geometry_SOURCE_PREFIX /home/pi/catkin_ws/src/vision_opencv/image_geometry)
  set(image_geometry_DEVEL_PREFIX /home/pi/catkin_ws/devel)
  ...
  set(image_geometry_INSTALL_PREFIX /home/pi/catkin_ws/install)
...
if(NOT "/home/pi/catkin_ws/src/vision_opencv/image_geometry/include;/usr/include;/usr/include/opencv " STREQUAL " ")
  set(image_geometry_INCLUDE_DIRS "")
  set(_include_dirs "/home/pi/catkin_ws/src/vision_opencv/image_geometry/include;/usr/include;/usr/include/opencv")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'image_geometry' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/catkin_ws/src/vision_opencv/image_geometry/${idir}'.  ${_report}")
    endif()
    _list_append_unique(image_geometry_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "image_geometry;/usr/lib/arm-linux-gnueabihf/libopencv_calib3d.so.3.2.0;/usr/lib/arm-linux-gnueabihf/libopencv_core.so.3.2.0;/usr/lib/arm-linux-gnueabihf/libopencv_features2d.so.3.2.0;/usr/lib/arm-linux-gnueabihf/libopencv_flann.so.3.2.0;/usr/lib/arm-linux-gnueabihf/libopencv_highgui.so.3.2.0;/usr/lib/arm-linux-gnueabihf/libopencv_imgcodecs.so.3.2.0;/usr/lib/arm-linux-gnueabihf/libopencv_imgproc.so.3.2.0;/usr/lib/arm-linux-gnueabihf/libopencv_ml.so.3.2.0;/usr/lib/arm-linux-gnueabihf/libopencv_objdetect.so.3.2.0;/usr/lib/arm-linux-gnueabihf/libopencv_photo.so.3.2.0;/usr/lib/arm-linux-gnueabihf/libopencv_shape.so.3.2.0;/usr/lib/arm-linux-gnueabihf/libopencv_stitching.so.3.2.0;/usr/lib/arm-linux-gnueabihf/libopencv_superres.so.3.2.0;/usr/lib/arm-linux-gnueabihf/libopencv_video.so.3.2.0;/usr/lib/arm-linux-gnueabihf/libopencv_videoio.so.3.2.0;/usr/lib/arm-linux-gnueabihf/libopencv_videostab.so.3.2.0;/usr/lib/arm-linux-gnueabihf/libopencv_viz.so.3.2.0;/usr/lib/arm-linux-gnueabihf/libopencv_aruco.so.3.2.0;/usr/lib/arm-linux-gnueabihf/libopencv_bgsegm.so.3.2.0;/usr/lib/arm-linux-gnueabihf/libopencv_bioinspired.so.3.2.0;/usr/lib/arm-linux-gnueabihf/libopencv_ccalib.so.3.2.0;/usr/lib/arm-linux-gnueabihf/libopencv_datasets.so.3.2.0;/usr/lib/arm-linux-gnueabihf/libopencv_dpm.so.3.2.0;/usr/lib/arm-linux-gnueabihf/libopencv_face.so.3.2.0;/usr/lib/arm-linux-gnueabihf/libopencv_freetype.so.3.2.0;/usr/lib/arm-linux-gnueabihf/libopencv_fuzzy.so.3.2.0;/usr/lib/arm-linux-gnueabihf/libopencv_hdf.so.3.2.0;/usr/lib/arm-linux-gnueabihf/libopencv_line_descriptor.so.3.2.0;/usr/lib/arm-linux-gnueabihf/libopencv_optflow.so.3.2.0;/usr/lib/arm-linux-gnueabihf/libopencv_phase_unwrapping.so.3.2.0;/usr/lib/arm-linux-gnueabihf/libopencv_plot.so.3.2.0;/usr/lib/arm-linux-gnueabihf/libopencv_reg.so.3.2.0;/usr/lib/arm-linux-gnueabihf/libopencv_rgbd.so.3.2.0;/usr/lib/arm-linux-gnueabihf/libopencv_saliency.so.3.2.0;/usr/lib/arm-linux-gnueabihf/libopencv_stereo.so.3.2.0;/usr/lib/arm-linux-gnueabihf/libopencv_structured_light.so.3.2.0;/usr/lib/arm-linux-gnueabihf/libopencv_surface_matching.so.3.2.0;/usr/lib/arm-linux-gnueabihf/libopencv_text.so.3.2.0;/usr/lib/arm-linux-gnueabihf/libopencv_ximgproc.so.3.2.0;/usr/lib/arm-linux-gnueabihf/libopencv_xobjdetect.so.3.2.0;/usr/lib/arm-linux-gnueabihf/libopencv_xphoto.so.3.2.0")
